...
import { useUploadFileMutation } from "../../store_RKIP/slices/mainApiSlice";
import { useUploadDocumentCSVMutation } from "../../store_RKIP/slices/processApiSlice"; // Import second API mutation
