...
import ChatWindow from "../components_RKIP/Process/ChatWindow";
import { useSendProcessMessageMutation } from "../store_RKIP/slices/processApiSlice";
import { PlaceholdersAndVanishInput } from "../components_RKIP/Process/placeholders-and-vanish-input";
import Header from "../components_RKIP/Process/Header";
...
export default function Process() {
 ...
 //Use RTK Query Mutation Hook for Process API
 const [sendProcessMessage] = useSendProcessMessageMutation();
  ...
  const handleSend = async (message: string) => {
    ...
    try {
      const response = await sendProcessMessage(message).unwrap();
      let index = 0;
    ...
    <div className="flex flex-col h-screen bg-white text-black p-0">
      ...
      <div className="p-4">
        <PlaceholdersAndVanishInput 
          placeholders={["Hello I am Process Bot!", "Ask something about Patent Process"]}
          onSubmit={(e) => {
            e.preventDefault();
