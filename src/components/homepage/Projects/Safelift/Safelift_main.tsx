...
import logo from "./assests_safelift/logo.png";
import HeroImage from "./assests_safelift/Hero Image.png";

export default function Safelift_Main() {
  return (
    <div 
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-3xl aspect-video rounded-lg overflow-hidden shadow-lg border border-gray-700">
        <video className="w-full h-full" controls muted autoPlay loop>
          <source src="/safelift.mp4" type="video/mp4" />
